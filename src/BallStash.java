...
public class BallStash {
	...
	//ADD methods:
	//getBucketBalls
        public static void getBucketBalls(int sizeBucket){ //fills golfers' buckets with balls from the stash (Called by Bollie)
	...
	// addBallsToStash
        public static void addBallsToStash(ArrayList<golfBall> balls, int ballsCollected){ //fills stash with balls from collected from the field
	...
	public static void setSizeStash (int noBalls) { //called initially by the driver class upon setting Driving Range in motion
		sizeStash=noBalls;
